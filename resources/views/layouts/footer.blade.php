            ...
            <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
                <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
                    <div class="flex items-center mb-2">
                        ...
                        {{-- <img src="home/src/img-min/logo.png" alt="LOGO"> --}}
                    </div>
                ...
                <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
                    <div class="flex flex-wrap flex-row">
                        <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
                            ...
                            <ul>
                                <li class="py-1 hover:text-gray-900"><a href="docs/index.html">Documentation</a>
                                </li>
                                <li class="py-1 hover:text-gray-900"><a href="docs/components.html">Components</a>
                                </li>
                                <li class="py-1 hover:text-gray-900"><a href="docs/credits.html">Credits</a></li>
                                <li class="py-1 hover:text-gray-900"><a href="docs/changelogs.html">Changelog</a>
                                </li>
                            </ul>
                        </div>
                        <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
...
<script src="home/src/vendors/glightbox/dist/js/glightbox.min.js"></script>
<script src="home/src/vendors/@splidejs/splide/dist/js/splide.min.js"></script>
<script src="home/src/vendors/typed.js/lib/typed.min.js"></script>
<script src="home/src/vendors/wow.js/dist/wow.min.js"></script>
<script src="home/src/vendors/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>
