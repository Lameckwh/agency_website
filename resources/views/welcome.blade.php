...
-->
 ...
 <head>
     ...
     <!-- Favicon  -->
     <link rel="icon" href="home/src/img/favicon.jpg">
 </head>
 ...
 <body class="text-gray-700">
             ...
             <div class="container xl:max-w-6xl mx-auto px-4">
                 <div class="lg:flex lg:justify-between">
                     <div class="flex justify-between items-center">
                         <div class="mx-w-10 text-4xl font-bold capitalize text-gray-900 flex items-center">Tailone
                         </div>
                         <!-- mobile nav -->
                             ...
                             <div class="relative text-gray-900 hover:text-black block lg:hidden">
                                 <div x-data="{ open: false }"
                                     ...
                                     <button type="button" @click="open = !open"
                                         ...
                                         <svg x-show="!open" class="open h-8 w-8" xmlns="http://www.w3.org/2000/svg"
                                             fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                             aria-hidden="true">
                                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                 d="M4 6h16M4 12h16M4 18h16"></path>
                                         </svg>
                                         <svg x-show="open" xmlns="http://www.w3.org/2000/svg" width="16"
                                             height="16" fill="currentColor" class="close bi bi-x-lg h-8 w-8"
                                             viewBox="0 0 16 16">
                     ...
                     <div class="flex flex-row lg:items-center">
                         <!-- nav menu -->
                         <ul x-show="!open"
                             class="navbar bg-white lg:bg-transparent w-full
                             hidden text-center lg:text-left lg:flex lg:flex-row text-gray-900 text-sm items-center
                             font-bold">
                             ...
                             <li class="relative">
                                 @guest
                                     ...
                                     <div class="ml-4 gap-3 hidden lg:flex">
                                         <a href="{{ route('login') }}"
                                             class="text-white px-4 py-2 border-b-2 border-transparent bg-blue-700 hover:bg-blue-800 rounded transition duration-150">Login</a>
                                         <a href="{{ route('register') }}"
                                             class="text-white px-4 py-2 border-b-2 border-transparent  bg-green-700 hover:bg-green-800 rounded transition duration-150">Register</a>
                                     </div>
                                 @else
                                     <!-- If user is logged in, show username and logout dropdown -->
     ...
     <main id="content">
             ...
             <div class="container xl:max-w-6xl mx-auto px-4">
                 <div class="flex flex-wrap flex-row -mx-4 justify-center">
                     ...
                     <div class="flex-shrink max-w-full px-4 sm:px-12 lg:px-18 w-full sm:w-9/12 lg:w-1/2 self-center">
                         <img src="home/src/img/dummy/hero.svg" class="w-full max-w-full h-auto"
                             alt="creative agency">
                     </div><!-- end content -->
                     ...
                     <div class="flex-shrink max-w-full px-4 w-full md:w-9/12 lg:w-1/2 self-center lg:pr-12">
                         <div class="text-center lg:text-left mt-6 lg:mt-0">
                             <div class="mb-12">
                                 ...
                                 <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2">We would
                                     direct
             ...
             <div class="flex flex-wrap flex-row">
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     ...
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img1.jpg" data-gallery="gallery1"
                             ...
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img1.jpg" alt="Image Description">
                             <div
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s" data-wow-delay=".1s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img2.jpg" data-gallery="gallery1"
                             data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content"
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img2.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development
                                 </h3>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s" data-wow-delay=".3s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img3.jpg" data-gallery="gallery1"
                             data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content"
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img3.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     ...
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img4.jpg" data-gallery="gallery1"
                             data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content"
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img4.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Logo Design</h3>
                                 <small class="d-block">Branding</small>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     ...
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img5.jpg" data-gallery="gallery1"
                             data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content"
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img5.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development
                                 </h3>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img6.jpg" data-gallery="gallery1"
                             ...
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img6.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Graphic Design</h3>
                                 <small class="d-block">Graphic</small>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s" data-wow-delay=".1s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img7.jpg" data-gallery="gallery1"
                             ...
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img7.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Logo Design</h3>
                                 <small class="d-block">Branding</small>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s" data-wow-delay=".3s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img8.jpg" data-gallery="gallery1"
                             ...
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img8.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development
                                 </h3>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s" data-wow-delay=".5s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img9.jpg" data-gallery="gallery1"
                             data-glightbox="title: Graphic Design; description: This is a wider card with supporting text below as a natural lead-in to additional content"
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img9.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                 <h3 class="text-base leading-normal font-semibold my-1 text-white">Graphic Design</h3>
                                 <small class="d-block">Graphic</small>
                 ...
                 <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp"
                     data-wow-duration="1s" data-wow-delay=".7s">
                     <div class="relative overflow-hidden cursor-pointer mb-6">
                         <a href="home/src/img/dummy/img10.jpg" data-gallery="gallery1"
                             ...
                             class="glightbox3">
                             <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                                 src="home/src/img/dummy/img10.jpg" alt="Image Description">
                             <div
                                 class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                                         ...
                                         <div class="w-full px-4 text-center pb-3">
                                             <a href="#" target="_blank">
                                                 <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                                                     src="home/src/img/dummy/img1.png" alt="Image Description">
                                             </a>
                                         </div>
                                     </div>
                                     <div class="splide__slide">
                                         <div class="w-full px-4 text-center pb-3">
                                             <a href="#" target="_blank">
                                                 <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                                                     src="home/src/img/dummy/img2.png" alt="Image Description">
                                             </a>
                                         </div>
                                     </div>
                                     <div class="splide__slide">
                                         <div class="w-full px-4 text-center pb-3">
                                             <a href="#" target="_blank">
                                                 <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                                                     src="home/src/img/dummy/img3.png" alt="Image Description">
                                             </a>
                                         </div>
                                     </div>
                                     <div class="splide__slide">
                                         <div class="w-full px-4 text-center pb-3">
                                             <a href="#" target="_blank">
                                                 <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                                                     src="home/src/img/dummy/img4.png" alt="Image Description">
                                             </a>
                                         </div>
                                     </div>
                                     <div class="splide__slide">
                                         <div class="w-full px-4 text-center pb-3">
                                             <a href="#" target="_blank">
                                                 <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                                                     src="home/src/img/dummy/img5.png" alt="Image Description">
                                             </a>
                                         </div>
                                     </div>
                                     <div class="splide__slide">
                                         <div class="w-full px-4 text-center pb-3">
                                             <a href="#" target="_blank">
                                                 <img class="grayscale mx-auto opacity-80 hover:opacity-100 max-w-full h-auto"
                                                     src="home/src/img/dummy/img6.png" alt="Image Description">
                                             </a>
                                         </div>
                                     </div>
                                 </div>
                 ...
                 <div class="flex flex-wrap flex-row -mx-4 justify-center">
                     <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                         <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                             ...
                             <div class="relative overflow-hidden px-6">
                                 <img src="home/src/img/dummy/avatar1.png"
                     ...
                     <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                         ...
                         <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                             data-wow-duration="1s" data-wow-delay=".1s">
                             <div class="relative overflow-hidden px-6">
                                 <img src="home/src/img/dummy/avatar3.png"
                                     class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale"
                                     alt="title image">
                             </div>
                             <div class="pt-6 text-center">
                     ...
                     <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                         ...
                         <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                             data-wow-duration="1s" data-wow-delay=".3s">
                             <div class="relative overflow-hidden px-6">
                                 <img src="home/src/img/dummy/avatar2.png"
                                     class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale"
                                     alt="title image">
                             </div>
                             <div class="pt-6 text-center">
                     ...
                     <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                         ...
                         <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                             data-wow-duration="1s" data-wow-delay=".5s">
                             <div class="relative overflow-hidden px-6">
                                 <img src="home/src/img/dummy/avatar4.png"
                                     class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale"
                                     alt="title image">
                             </div>
                             <div class="pt-6 text-center">
         ...
         <!-- Latest News Starts -->
         <div id="latest_news" class="section relative pt-20 pb-8 md:pt-16 bg-white dark:bg-gray-800">
             <div class="container xl:max-w-6xl mx-auto px-4">
                 <header class="text-center mx-auto mb-12">
                     <h2 class="text-2xl leading-normal mb-2 font-bold text-gray-800 dark:text-gray-100">
                         <span class="font-light">Latest</span> News
                     </h2>
                     <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 60"
                         style="margin: 0 auto;height: 35px;" xml:space="preserve">
                                                             ...
                                                             <div class="hover-img bg-white">
                                                                 ...
                                                                 <div class="py-3 px-6">
                                                                     ...
                                                                     <a class="text-gray-500" href="#">
                                                                         <span
                                                                             class="inline-block h-3 border-l-2 border-red-600 mr-2"></span>Europe
                                                                     </a>
                                                                 </div>
                                                             </div>
                                                         </div>
